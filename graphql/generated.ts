...
export type NewsModelBodyField = AlertRecord | BannerRecord | BloccoGraficoRecord | ButtonRecord | DataHeroRecord | HeroRecord | LatestRecord | SplitBannerRecord;
...
export type PageModelBodyField = AlertRecord | BannerRecord | BloccoGraficoRecord | ButtonRecord | CardServiceRecord | DataHeroRecord | HeroRecord | LatestRecord | NavScrollRecord | RichTextRecord | SplitBannerRecord | VideoPlayerRecord;
...
export type PageModelFilter = {
  ...
  slug?: InputMaybe<SlugFilter>;
  title?: InputMaybe<StringFilter>;
  updateDate?: InputMaybe<StringFilter>;
};
