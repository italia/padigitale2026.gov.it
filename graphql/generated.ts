...
export type FaqModelBodyField = BannerRecord | CardsGridAttachmentRecord | CardsGridGenericRecord | CardsGridNewsRecord | CardsGridRecord | CardsGridResourceRecord | CardsGridServiceRecord | DataHeroRecord | HeroRecord | LayoutSidebarRecord | RichTextSectionRecord | SplitBannerRecord | VideoPlayerRecord;
...
export type NewsModelBodyField = BannerRecord | BloccoGraficoRecord | CardsGridAttachmentRecord | CardsGridGenericRecord | CardsGridNewsRecord | CardsGridRecord | CardsGridResourceRecord | CardsGridServiceRecord | DataHeroRecord | HeroRecord | LatestRecord | LayoutSidebarRecord | RichTextSectionRecord | SplitBannerRecord | VideoPlayerRecord;
...
export type PageModelBodyField = BannerRecord | BloccoGraficoRecord | CardsGridAttachmentRecord | CardsGridGenericRecord | CardsGridNewsRecord | CardsGridRecord | CardsGridResourceRecord | CardsGridServiceRecord | DataHeroRecord | HeroRecord | LatestRecord | LayoutSidebarRecord | RichTextSectionRecord | SplitBannerRecord | TableListRecord | VideoPlayerRecord;
...
export type ResourceModelBodyField = BannerRecord | CardsGridAttachmentRecord | CardsGridGenericRecord | CardsGridNewsRecord | CardsGridRecord | CardsGridResourceRecord | CardsGridServiceRecord | DataHeroRecord | HeroRecord | LayoutSidebarRecord | RichTextSectionRecord | SplitBannerRecord | VideoPlayerRecord;
...
export type RichTextModelContentBlocksField = ButtonRecord | CardsGridAttachmentRecord | CardsGridGenericRecord | CardsGridNewsRecord | CardsGridRecord | CardsGridResourceRecord | CardsGridServiceRecord | ImagesGridRecord | LinkRecord | VideoPlayerRecord;
